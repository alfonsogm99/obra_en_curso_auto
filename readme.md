...
Previamente, se ha realizado un análisis de los datos que se van a exportar para identificar las columnas y los valores necesarios.



1\. Preparar la plantilla '.xlsx'.

2\. Extraer la información de los talleres en formato '.csv' de la BD.

**--el script.py:**

3\. Separa los datos en columnas.

4\. Filtra la información para obtener únicamente los valores de las columnas requeridas.

5\. Calcula el número de órdenes de reparación (OR) abiertas.
